...
export default function SignUp() {
  ...
  React.useEffect(() => {
    ...
    Axios.get('http://http://vpnptec.dyndns.org:32001//api/Provinces_List', { headers })
  ...
  const handleChange_amphures_List = (event: SelectChangeEvent, name) => {
    ...
    Axios.get('http://http://vpnptec.dyndns.org:32001//api/Districts_List', { headers })
      .then(response => {
  ...
  const handleChange_provinces_List = (event: SelectChangeEvent, name) => {
    ...
    Axios.get('http://http://vpnptec.dyndns.org:32001//api/Amphures_List', { headers })
      .then(response => {
  ...
  const handle_sumbitForms = (event) => {
    ...
    if (!forms.Name && !forms.Tell && !forms.Email) {
      ...
      Axios.post('http://http://vpnptec.dyndns.org:32001//api/NewNTI_Station_Create', body, { headers })
        .then(response => {
          if (response) {
